...
@interface KeyboardBar : UIView<UITextFieldDelegate>

- (id)initWithDelegate:(id<KeyboardBarDelegate>)delegate;

@property (strong, nonatomic) UITextField *textField;//UITextView *textView;
@property (strong, nonatomic) UIButton *actionButton;
@property (strong, nonatomic) UILabel *labelFieldCaption;
